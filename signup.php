            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <div class="card card-signup">
                        ...
                        <p class="text-divider">Or <a href="index.php">LOGIN NOW</a></p>
                        <div class="content">
                            <form action="php/signup.php" method="post">
                                    ...
                                    <div class="col-xs-2">
                                        <center>
                                            <i class="material-icons"
                                               style="margin-top:35px; margin-left:15px;">email</i>
                                        </center>
                                    </div>
                                    <div class="col-xs-10">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Enter Email as Username</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-2">
                                        <center>
                                            <i class="material-icons" style="margin-top:35px; margin-left:15px;"><i
                                                    class="material-icons">vpn_key</i></i>
                                        </center>
                                    </div>
                                    <div class="col-xs-10">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Enter Shared Key</label>
                                ...
                                <div class="footer text-center">
                                    <center>
                                        <button class="btn btn-simple btn-primary btn-lg" type="submit">Get
                                            Started
                                        </button>
                                    </center>
                                </div>
